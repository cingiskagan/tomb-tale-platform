 ...
 * <ul>
 *   <li><b>CSRF disabled</b> — this API is stateless and uses {@code Authorization: Bearer}
 *       headers, not cookies. CSRF attacks only exploit cookie-based authentication where
 *       the browser automatically attaches credentials. With JWTs sent explicitly via headers,
 *       there is no CSRF attack vector.</li>
 *   <li><b>Stateless sessions</b> — no server-side session is created; every request is
...
public class SecurityConfig {
     ...
     * </ul>
     *
     * <p>All other paths require a valid Zitadel-issued JWT.
     *
